 ...
 */
package com.speedtong.example.meeting.ui.manager;
...
import com.speedtong.example.meeting.common.utils.MimeTypesTools;
...
public class CCPAppManager {
	...
	public static ArrayList<CCPBaseActivity> activities = new ArrayList<CCPBaseActivity>();
	...
	public static void addActivity(CCPBaseActivity activity) {
		activities.add(activity);
	}
	
	public static void clearActivity() {
		for(CCPBaseActivity activity : activities) {
			if(activity != null) {
				activity.finish();

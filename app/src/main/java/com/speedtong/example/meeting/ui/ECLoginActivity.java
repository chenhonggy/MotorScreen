...
import com.speedtong.example.meeting.common.utils.DensityUtil;
...
import com.speedtong.example.meeting.view.CCPFormInputView;
import com.speedtong.example.meeting.view.ECProgressDialog;
 ...
 * @version 4.0
 */
public class ECLoginActivity extends CCPBaseActivity implements
	...
	private void initResourceRefs() {
		...
		tv_regist_tip1
				.setText(Html.fromHtml(getString(R.string.tips_regist_1)));
	}
						...
						new InnerRequestListener() {
							...
							public void onECRequestException(CCPException arg0) {
								ECLog4Util.e("TAG", "onECRequestException "
										+ arg0.getMessage());
								ToastUtil.showMessage("请检查您的网络测试.");
										...
										if ("000000".equals(mJSONObject
											...
											for (int i = 0; i < length; i++) {
												...
												ECContacts bean = new ECContacts(
														object.getString("voip_account"));
												bean.setToken(object
														.getString("voip_token"));
												bean.setSubAccount(object
														.getString("sub_account"));
												bean.setSubToken(object
														.getString("sub_token"));
												arraylist.add((bean));
											}
											saveAutoLogin(appId);
											Intent intent = new Intent(
													ECLoginActivity.this,
													ECAccountChooseActivity.class);
	 ...
	 * 保存云通讯的获取账号登陆账号
	 */
	private void saveAutoLogin(String appId) {
		try {
			...
			ECPreferenceSettings settingsAppId = ECPreferenceSettings.SETTINGS_YUNTONGXUN_APPID;
			ECPreferences.savePreference(settingsAppId, appId, true);
